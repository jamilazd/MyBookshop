...
const bookLists = [
...

    {
        ...
        image: "http://books.google.com/books/content?id=O9yKCgAAQBAJ&amp;printsec=frontcover&amp;img=1&amp;zoom=1&amp;edge=curl&amp;source=gbs_api", 
        button: "Add", 
    }, 

    {
        ...
        image: "http://books.google.com/books/content?id=jXqaDwAAQBAJ&amp;printsec=frontcover&amp;img=1&amp;zoom=5&amp;edge=curl&amp;source=gbs_api", 
        button: "Add", 
    }, 

    {
        ...
        image: "http://books.google.com/books/content?id=eD90DwAAQBAJ&amp;printsec=frontcover&amp;img=1&amp;zoom=5&amp;edge=curl&amp;source=gbs_api", 
        button: "Add", 
    }, 

    {
        ...
        image: "http://books.google.com/books/content?id=fjadDwAAQBAJ&amp;printsec=frontcover&amp;img=1&amp;zoom=5&amp;edge=curl&amp;source=gbs_api", 
        button: "Add", 
    }, 
...
function createDisplayOfBooks() {
  const allTheBooks = [];
  for (const book of bookLists) {
  allTheBooks.push(
  `<div class="book">
  <img class="image" src="${book.image}" alt="${book.bookName}">
  <article>
        <h2 title="${book.bookName}">${book.bookName}</h2>
        <p class="author">by ${book.author}</p>
        <p class="price">£ ${book.price}</p>
        <summary class="description">${book.description}</summary>
        <button class="button" type="button">${book.button}</button> 
  </article>
  </div>`);

}

 listContainer.innerHTML = allTheBooks.join('')  
}

createDisplayOfBooks() 
