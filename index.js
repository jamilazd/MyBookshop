...
const bookLists = [
...

  {
    ...
    price: 3.83,
    description:
      "Real, raw, and funny, the voice of John S. Green takes you on a lifelong journey of seeking sacred resting places in the middle of lifes ever increasing chaos and distractions. Headlines scream, Beware! Look out! The end is near! A lightning, flashing, neon pulse that blinds us from the ordinary light.",
    image:
...
for (const book of bookLists) {
  allTheBooks.push(`<div class="book">
                           <img src="${book.image}" alt="${book.bookName}"
                    <article>
                                        <h2 title="${book.bookName}">${book.bookName}</h2>
                                        <p class="author">by ${book.author}</p>
                                        <p class="price">${book.price}</p>
                                        <summary class="description">${book.description}
                                        </summary>
                                    </article>
   </div>`);
}
